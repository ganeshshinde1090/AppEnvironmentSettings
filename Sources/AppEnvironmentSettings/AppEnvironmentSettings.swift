...
public extension View {
    func showAppEnvironmentSetting(onChange: ((EnvironmentValues.Diff) -> Void)? = nil) -> some View {
        modifier(AppEnvironmentModifires(onChange: onChange) )
    }
}

    
struct AppEnvironmentModifires: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .onAppear { self.applyDefaultSettings() }
            ...
            .overlay(AppEnvironmentSettingsView(params: settings),
...
struct AppEnvironmentSettingsView: View {
...
struct AppEnvironmentSettingsView_Previews: PreviewProvider {
    static var previews: some View {
        bgView
            .overlay(AppEnvironmentSettingsView(params: .preview()),
                     alignment: .bottomTrailing)
            .colorScheme(.light)
    }
